...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(uwu-theme :location (recipe :fetcher github :repo "kborling/uwu-theme"))
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   dotspacemacs-line-numbers t '(:disabled-for-modes
                                 org-mode)
